...
_PHASE_TO_NODE_NAME: dict[PhaseKey, str] = {
    ...
    # Old checkpoints may resume at the removed phase. Route them forward
    # instead of breaking deserialization or asking the student legacy questions.
    "reference_confirm": "m2_output_gen",
