// Shared UI: Brand, Sidebar, Topbar, AppShell, Badge, Button helpers.
...
const NAV_ITEMS = [
  ...
  { id: "wizard", label: "New Thesis", icon: "plus", badge: "AI" },
];
...
// ---------- Topbar ----------
const Topbar = ({ crumbs = [], rightExtra }) => (
...
const ProgressBar = ({ value, color = "var(--blue-600)", track = "var(--ink-100)", height = 8 }) => (
...
window.SHARED = { Sidebar, Topbar, Badge, Card, ProgressBar, KPI, BrandMark, Brand };
