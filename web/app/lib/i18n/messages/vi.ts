...
export const vi: Record<MessageKey, string> = {
  ...
  "nav.blogPosts": "Bài blog",
  "nav.blogCategories": "Chuyên mục",
  ...
  "run.tool.parse_reference": "Đang đọc một tài liệu tham khảo",
  "run.tool.topic_feasibility": "Đang kiểm tra tính khả thi của đề tài",
  "run.tool.audit_instrument": "Đang rà soát bảng hỏi",
  "run.tool.sampling_plan": "Đang tính cỡ mẫu cần thiết",
  "run.tool.consent_notice": "Đang soạn phần đồng ý tham gia khảo sát",
  "run.tool.make_google_form_script": "Đang tạo bản khảo sát Google Form",
  "run.tool.methods_preflight": "Đang đối chiếu phương pháp với mô hình",
  "run.tool.render_model_diagram": "Đang vẽ mô hình nghiên cứu",
  "run.tool.run_stats": "Đang chạy phân tích thống kê",
  "run.tool.check_thresholds": "Đang đối chiếu kết quả với ngưỡng kiểm định",
  "run.tool.parse_output_table": "Đang đọc bảng kết quả",
  "run.tool.parse_smartpls_export": "Đang đọc kết quả xuất từ SmartPLS",
  "run.tool.render_verified_sections": "Đang dựng các bảng đã kiểm chứng",
  "run.tool.export_docx": "Đang xuất file luận văn",
  "run.tool.humanize_text": "Đang viết lại cho tự nhiên hơn",
  "run.tool.review_thesis": "Đang rà soát lại toàn bộ luận văn",
  "run.tool.generate_committee_questions": "Đang chuẩn bị câu hỏi hội đồng",
  "run.tool.set_defense_date": "Đang ghi lịch bảo vệ",
  "run.tool.read_slice": "Đang xem lại phần đã làm",
  "run.tool.commit_slice": "Đang lưu kết quả của bước này",
  "run.tool.backfill_upstream_modules": "Đang bổ sung các chương phía trước",
  "run.tool.ingest_advisor_feedback": "Đang ghi nhận góp ý của giảng viên",
  "run.tool.mark_feedback_addressed": "Đang đánh dấu góp ý đã xử lý",
  "run.tool.flag_blocker": "Đang ghi nhận một vướng mắc",
  "run.tool.resolve_blocker": "Đang xử lý vướng mắc",
  "run.tool.unknown": "Đang xử lý…",
  ...
  "txn.title": "Giao dịch",
  "txn.subtitle": "Mọi credit vào và ra khỏi tài khoản.",
  "txn.balance": "{count} credit",
  "txn.today": "Hôm nay",
  "txn.yesterday": "Hôm qua",
  "txn.group.count": "×{count}",
  "txn.emptyHint": "Nạp credit, chat, hoặc chạy Auto Thesis thì dòng sẽ hiện ở đây.",
  ...
  "txn.reason.chatTurn": "Chat",
  "txn.reason.autoRun": "Auto Thesis",
  ...
  // --- lộ trình: tên module, các bước, và thẻ TIẾP THEO ---
  "roadmap.module.M1": "M1 · Đề tài & câu hỏi nghiên cứu",
  "roadmap.module.M2": "M2 · Khoảng trống & giả thuyết",
  "roadmap.module.M3": "M3 · Phương pháp & mô hình",
  "roadmap.module.M4": "M4 · Phân tích dữ liệu",
  "roadmap.module.M5": "M5 · Kết luận",

  "roadmap.substep.frame_topic": "Xác định đề tài",
  "roadmap.substep.propose_titles": "Đề xuất tên đề tài",
  "roadmap.substep.confirm_title": "Chốt tên đề tài",
  "roadmap.substep.derive_questions": "Xây dựng câu hỏi nghiên cứu",
  "roadmap.substep.familiarize": "Tìm hiểu tổng quan lĩnh vực",
  "roadmap.substep.map_research_state": "Hệ thống hoá tình hình nghiên cứu",
  "roadmap.substep.find_gaps": "Tìm khoảng trống nghiên cứu",
  "roadmap.substep.generate_output": "Viết tổng quan tài liệu",
  "roadmap.substep.define_constructs": "Xác định các khái niệm nghiên cứu",
  "roadmap.substep.build_model": "Xây dựng mô hình nghiên cứu",
  "roadmap.substep.state_hypotheses": "Phát biểu giả thuyết",
  "roadmap.substep.choose_method": "Chọn phương pháp phân tích",
  // "Thang đo" là chữ trong chương 3 của chính sinh viên; "instrument" chỉ là
  // tên khoá lưu trữ ở backend.
  "roadmap.substep.design_instrument": "Xây dựng thang đo (bảng câu hỏi)",
  "roadmap.substep.detect_data": "Nhận diện bộ dữ liệu",
  "roadmap.substep.outline_analysis": "Lập kế hoạch phân tích",
  "roadmap.substep.confirm_plan": "Chốt kế hoạch phân tích",
  "roadmap.substep.run_per_step": "Chạy từng bước phân tích",
  "roadmap.substep.interpret": "Diễn giải kết quả",
  "roadmap.substep.write_conclusion": "Viết kết luận",
  "roadmap.substep.export": "Xuất file luận văn",

  "roadmap.next.label": "Tiếp theo",
  "roadmap.next.title.confirm": "Xác nhận hoàn thành {module}",
  "roadmap.next.title.allDone": "Xuất luận văn & chuẩn bị bảo vệ",
  "roadmap.next.why.substep": "Đây là bước tiếp theo trong module bạn đang làm.",
  "roadmap.next.why.confirm": "{module} đã có đủ nội dung — xác nhận để đi tiếp.",
  "roadmap.next.why.nextModule": "{focus} đã xong — tiếp theo là {module}.",
  "roadmap.next.why.allDone":
    "Tất cả module đã xong — xuất file hoàn chỉnh và tập bảo vệ thôi.",
  "roadmap.next.cta.skipModule": "Bỏ qua, sang module sau",
  "roadmap.next.cta.markDone": "Đánh dấu {module} đã xong",
  "roadmap.next.cta.notYet": "Chưa xong",
  "roadmap.next.cta.start": "Bắt đầu {module}",
  "roadmap.next.cta.whatInvolves": "{module} gồm những gì?",
  "roadmap.next.cta.fix": "Khắc phục thế nào?",
  "roadmap.next.cta.skipForNow": "Tạm bỏ qua",
  "roadmap.next.cta.export": "Xuất luận văn",
  "roadmap.next.cta.defense": "Chuẩn bị bảo vệ",
  "roadmap.next.cta.review": "Xem lại trước đã",

  "roadmap.steps.current": "Bước hiện tại: {label}",
  "roadmap.steps.done": "Đã xong {done}/{total} bước",
  "roadmap.timeline.thisWeek": "Tuần này: {what}",
  "roadmap.timeline.onTrack": "Đúng tiến độ",
  "roadmap.timeline.behind": "Chậm khoảng {weeks} tuần",

  // --- /credit ---
  "credit.title": "Nạp credit",
  "credit.subtitle": "Chỉ trừ khi bạn bắt đầu chạy. Engine lỗi thì hoàn lại.",
  "credit.equivHint": "Một luận văn Auto Thesis đủ 5 chương khoảng {credits} credit. Topic dài tốn hơn.",
  "credit.thesesEquiv_one": "≈ {label} luận văn hoàn thiện",
  "credit.thesesEquiv_other": "≈ {label} luận văn hoàn thiện",
  "credit.balance": "{count} credit",
  "credit.theses": "Luận văn",
  "credit.orders": "Đơn hàng",
  "credit.paid": "Thanh toán thành công. Credit sẽ được cộng trong giây lát.",
  "credit.loading": "Đang tải gói…",
  "credit.loadError": "Không tải được bảng giá.",
  "credit.payCard": "Thanh toán thẻ",
  "credit.payCardBusy": "Đang mở…",
  "credit.paypalBusy": "Đang mở…",
  "credit.sepay": "Chuyển khoản",
  "credit.sepayBusy": "Đang tạo…",
  "credit.save": "Giảm {pct}%",
  "credit.credits": "{count} credit",
  "credit.perK": "{price} / 1.000 credit",
  "credit.cheaper": "Rẻ hơn Starter {pct}% mỗi credit",
  "credit.featured": "Chọn nhiều nhất",
  "credit.bestRate": "Rẻ nhất mỗi credit",
  "credit.pkg.starter_package": "Starter",
  "credit.pkg.standard_package": "Standard",
  "credit.pkg.expert_package": "Expert",
  "credit.blurb.starter_package": "Nạp đúng lúc cần, không dư.",
  "credit.blurb.standard_package": "Gói mọi người hay lấy.",
  "credit.blurb.expert_package": "Giá mỗi credit thấp nhất.",
  "credit.notesTitle": "Nếu có sự cố",
  "credit.note.refund": "Hoàn 100% nếu tool lỗi hoặc không xuất được bản thảo.",
  "credit.note.deduct": "Trừ khi bắt đầu chạy. Engine lỗi thì hoàn tự động.",
  "credit.note.confirm": "Credit được cộng trong 1-3 phút sau khi thanh toán xác nhận.",
  "credit.sepay.title": "Chuyển khoản qua SePay",
  "credit.sepay.hint": "Quét mã QR hoặc chuyển khoản đúng nội dung. Credit cộng sau 1-2 phút.",
  "credit.sepay.paid": "Đã nhận thanh toán. Credit đã được cộng.",
  "credit.sepay.bank": "Ngân hàng",
  "credit.sepay.account": "Số tài khoản",
  "credit.sepay.amount": "Số tiền",
  "credit.sepay.content": "Nội dung",
  "credit.sepay.keepCode": "Giữ nguyên mã {code} trong nội dung chuyển khoản để hệ thống cộng credit tự động.",
  "credit.sepay.waiting": "Đang chờ thanh toán…",
  ...
  "chat.composer.usingSkill": "Đang dùng {skill}",
  "chat.composer.clearSkill": "Bỏ chọn",
  "chat.composer.hintNewline": "xuống dòng",
  "chat.composer.hintPasteScreenshot": "dán ảnh chụp màn hình",
  "chat.contextUsage.normal": "Context {used} · compact sau {remaining} · {percent}%",
  "chat.contextUsage.compacting": "Context {used} · đang tự động compact…",
  "chat.contextUsage.title": "Ngữ cảnh hiện tại của thread trước khi tự động compact",

  // --- context panel / module slices ---
  "context.field.methodology": "Phương pháp",
  "context.field.paradigm": "Paradigm",
  "context.field.design": "Thiết kế nghiên cứu",
  "context.field.tool": "Công cụ phân tích",
  "context.field.sample": "Cỡ mẫu",
  "context.field.sampling_strategy": "Cách lấy mẫu",
  "context.field.target_sample": "Cỡ mẫu mục tiêu",
  "context.field.mixed_design": "Thiết kế hỗn hợp",
  ...
  "context.empty.nothingCommitted": "Chưa có gì được lưu.",
  "context.empty.m1NotSet": "Chưa có đề tài — bắt đầu từ M1.",
  "context.empty.m1None": "Chưa có dữ liệu M1.",
  "context.empty.m2None": "Chưa có tài liệu — chạy M2 scout để thu thập nguồn.",
  "context.empty.m2DataNone": "Chưa có dữ liệu M2.",
  "context.empty.m5NotWritten":
    "Chưa viết — M5 thêm chương kết luận. Chương 1–4 do M1–M4 viết khi bạn hoàn thành từng phần, nên bạn có thể xuất bất cứ lúc nào.",
  "context.empty.noSources": "Chưa có nguồn.",
  "context.empty.noConceptualModel": "Chưa có sơ đồ mô hình khái niệm.",
  "context.empty.questionnaireEmpty": "Bảng câu hỏi trống.",
  ...
  // Trình xem tệp — giữ nguyên đúng chuỗi đã hiển thị trước khi tách i18n.
  "preview.open": "Xem {name}",
  "preview.download": "Tải xuống {name}",
  "preview.tab.document": "Tài liệu",
  "preview.tab.text": "Văn bản",
  "preview.download.action": "Tải xuống",
  "preview.close": "Đóng",
  "preview.loading": "Đang mở tệp…",
  "preview.error.render": "Không hiển thị được tệp này. Thử tab “Văn bản” hoặc tải xuống.",
  "preview.error.noDocumentView": "Định dạng này không có bản xem tài liệu — xem tab “Văn bản”.",
  "preview.error.noText": "Chưa có bản trích xuất văn bản cho tệp này — tải xuống để mở bằng Word.",
  "preview.error.unreadable": "Không đọc được nội dung tệp này.",
  "preview.subtitle.pdf": "Bản xem PDF",
  "preview.subtitle.docx": "Bản xem tài liệu Word",
  "preview.subtitle.data": "Bộ dữ liệu — xem cấu trúc bên dưới",
  "preview.subtitle.plain": "Văn bản",

  // Phạm vi kết xuất — giữ nguyên đúng chuỗi đã hiển thị trước khi tách i18n.
  "export.scope.document": "Tài liệu",
  "export.scope.full": "Toàn bộ luận văn",
  "export.scope.M1": "M1 · Chủ đề",
  "export.scope.M2": "M2 · Tổng quan",
  "export.scope.M3": "M3 · Phương pháp",
  "export.scope.M4": "M4 · Phân tích",
  "export.scope.M5": "M5 · Kết luận",
  "export.scope.chapter.intro": "Chương 1",
  "export.scope.chapter.lit_review": "Chương 2",
  "export.scope.chapter.methodology": "Chương 3",
  "export.scope.chapter.results": "Chương 4",
  "export.scope.chapter.conclusion": "Chương 5",
  "export.scope.chapters1to3": "Chương 1–3",

  // Thanh tiêu điểm (ChatHeader).
  "focus.status.in_progress": "Đang làm",
  "focus.status.done": "Xong",
  "focus.status.locked": "Chưa mở",
  "focus.phase.M2": "Phân tích khoảng trống",
  "focus.phase.M3": "Mô hình đo lường",
  "focus.phase.M4": "Quy trình phân tích",
  "focus.phase.M5": "Trình tự chương",
  "focus.openEditor": "Mở trình soạn thảo",
  "focus.backHome": "Về trang chủ",
  "focus.openMenu": "Mở menu",
  "focus.openContext": "Mở bảng ngữ cảnh",
  "focus.contextPanel": "Bảng ngữ cảnh",
  "focus.loading": "Đang tải luận văn",
  "focus.tier.admin": "Quản trị",
  "focus.tier.student": "Học viên Pro",
  "focus.you": "Bạn",

  // Luồng chat trống — lời chào đầu phiên.
  "chat.empty.pickingUp": "Tiếp tục “{title}”",
  "chat.empty.continuing": "Tiếp tục luận văn của bạn",
  "chat.empty.upNext": "{module} là bước tiếp theo — {hint} Nhập bên dưới để bắt đầu, hoặc hỏi về bất kỳ phần nào.",
  "chat.empty.coldTitle": "Bắt đầu luận văn",
  "chat.empty.coldBody":
    "Nhập đề tài nghiên cứu bên dưới và mình sẽ hướng dẫn từng bước — hoặc bấm Auto Thesis để viết trọn vẹn từ đầu đến cuối.",
  "chat.empty.hint.M1": "cho mình biết lĩnh vực bạn muốn nghiên cứu.",
  "chat.empty.hint.M2": "cùng rà soát tài liệu và tìm khoảng trống cho giả thuyết của bạn.",
  "chat.empty.hint.M3": "đến lúc chọn hệ hình, thiết kế và công cụ đo.",
  "chat.empty.hint.M4": "sẵn sàng xử lý dữ liệu ngay khi bạn có.",
  "chat.empty.hint.M5": "cùng chuyển dự án thành các chương và kết xuất.",

  // Khung bảng Workspace.
  "context.workspace": "Không gian làm việc",
  "context.rawJson": "JSON gốc",
  "context.rawJson.toggle": "Bật/tắt JSON gốc",
  "context.threadCredits": "Credits đã dùng trong cuộc trò chuyện này",
  "context.live": "Trực tiếp · tự động lưu",
  "context.viewHistory": "Xem lịch sử",
  "context.outputs.empty":
    "Chưa có kết xuất nào — hãy yêu cầu xuất một phần hoặc toàn bộ luận văn, hoặc dùng Quick actions → Xuất ra Word.",
  "context.viewFullTopic": "Xem toàn bộ đề tài",
  ...
  "editor.sources.title": "Nguồn ({count})",
  "editor.sources.empty": "Chưa có tài liệu nào.",
  "editor.sources.open": "Mở bài báo ở tab mới",
  "editor.diff.title": "Thay đổi chưa lưu",
  "editor.diff.legend": "Xanh là thêm, đỏ là xoá, xám là giữ nguyên.",
  "editor.diff.none": "Không có gì khác so với bản đã lưu.",
  "editor.diff.close": "Đóng",
  "editor.save.clean": "Chưa có thay đổi",
  "editor.save.unsaved": "Có thay đổi chưa lưu",
  "editor.save.saving": "Đang lưu…",
  "editor.save.savedAt": "Đã lưu lúc {time}",
  "editor.save.action": "Lưu",
  "editor.save.failed": "Chưa lưu được — giữ tab này mở và thử lại.",
  "editor.backToChat": "Về phòng chat",
  "editor.export.download": "Tải {kind}",
  "editor.export.last": "Xuất lần cuối:",
  "editor.export.never": "chưa xuất",
  "editor.export.justNow": "vừa xong",
  "editor.export.minutesAgo": "{count} phút trước",
  "editor.export.hoursAgo": "{count} giờ trước",
  "editor.export.editsSince": "{count} chỉnh sửa từ đó",
  "editor.export.failed": "Xuất thất bại — {message}",
  "editor.export.exporting": "Đang xuất…",
  "editor.export.reExport": "Xuất lại",
  "chat.exportCard.title": "LUẬN VĂN ĐÃ XUẤT",
  "chat.exportCard.preparing": "Đang chuẩn bị…",
  "chat.exportCard.started": "Đã bắt đầu tải",
  "chat.exportCard.noUrl": "Tệp này không có đường dẫn tải về.",
  "chat.contextSummary.title": "Đã tóm tắt hội thoại để tiếp tục",
  "chat.contextSummary.hint":
    "Hội thoại đã dài nên được rút gọn thành ghi chú dưới đây — từ đây trở đi trợ lý chỉ nhớ phần này. Nếu sau đó có gì sai, xem lại chỗ này.",
  "composer.quickActions": "Thao tác nhanh",
  "composer.quickActions.sectionRun": "Chạy",
  "composer.quickActions.sectionExport": "Xuất ra Word",
  "composer.quickActions.sectionMore": "Khác",
  "composer.quickActions.exportModules": "Xuất các phần → .docx…",
  "composer.quickActions.versionHistory": "Lịch sử phiên bản",
  "composer.quickActions.notifications": "Thông báo",
  "composer.quickActions.downloadThesis": "Tải luận văn (.docx)",
  "composer.quickActions.downloadUnavailable": "Chưa có bản xuất — hoàn thành M5 trước",
  "composer.quickActions.downloadNotYet": "chưa có",
  "composer.quickActions.downloadPreparing": "Đang chuẩn bị…",
  "composer.quickActions.downloadError": "Lỗi: {message}",
  "context.section.outputs": "Kết xuất",
  ...
  "context.modal.methodology": "Phương pháp",
  "context.modal.conceptualModel": "Mô hình khái niệm",
  "context.modal.hypotheses": "Giả thuyết ({count})",
  "context.modal.questionnaire": "Bảng câu hỏi",
  "context.modal.methodologySubtitle": "Thiết kế · lấy mẫu · phân tích",
  "context.modal.conceptualModelSubtitle": "Biến và quan hệ giả thuyết",
  "context.modal.hypothesesSubtitle": "Tất cả giả thuyết đã lưu",
  ...
  "context.value.paradigm.interpretivist": "Giải thích (interpretivist)",
  "context.value.paradigm.constructivist": "Kiến tạo (constructivist)",
  "context.value.paradigm.pragmatist": "Thực dụng (pragmatist)",
  "context.value.paradigm.quantitative": "Định lượng",
  "context.value.paradigm.qualitative": "Định tính",
  "context.value.paradigm.mixed": "Hỗn hợp",

  "context.value.design.cross_sectional_survey": "Khảo sát cắt ngang",
  "context.value.design.longitudinal_survey": "Khảo sát dọc",
  "context.value.design.survey": "Khảo sát",
  "context.value.design.pls_sem": "PLS-SEM",
  "context.value.design.cb_sem": "CB-SEM",
  "context.value.design.case_study": "Nghiên cứu tình huống",
  "context.value.design.experiment": "Thí nghiệm",

  // --- admin list filters ---
  "admin.papers.title": "Luận văn",
  "admin.papers.subtitle": "Mọi dự án luận văn của tất cả người dùng.",
  "admin.filters.topic": "Đề tài",
  "admin.filters.owner": "Chủ sở hữu",
  "admin.filters.module": "Module",
  "admin.filters.status": "Trạng thái",
  "admin.filters.searchTopic": "Tìm đề tài hoặc lĩnh vực…",
  "admin.filters.searchOwner": "Lọc theo email chủ sở hữu",
  "admin.filters.allModules": "Tất cả module",
  "admin.filters.allStatus": "Mọi trạng thái",
  "admin.filters.allStatuses": "Mọi trạng thái",
  "admin.jobs.title": "Job",
  "admin.orders.title": "Đơn hàng",
  "admin.blog.allLocales": "Mọi ngôn ngữ",
  "admin.blog.allStatuses": "Mọi trạng thái",
  "admin.blog.draft": "Nháp",
  "admin.blog.published": "Đã xuất bản",
  "admin.blog.scheduled": "Hẹn giờ",
  "admin.blog.search": "Tìm",
};
