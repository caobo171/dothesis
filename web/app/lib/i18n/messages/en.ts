...
export const en = {
  ...
  "txn.subtitle": "Every credit in and out of your account.",
  "txn.balance": "{count} credits",
  "txn.today": "Today",
  "txn.yesterday": "Yesterday",
  "txn.group.count": "×{count}",
  "txn.emptyHint": "Top up, chat, or run Auto Thesis and the movement shows up here.",
  "txn.col.date": "Date",
  ...
  // --- /credit — buy a pack ---
  "credit.title": "Buy credits",
  "credit.subtitle": "Charged only when a run actually starts. Refunded if the engine errors.",
  "credit.equivHint": "One complete Auto Thesis (5 chapters) is about {credits} credits. A longer topic costs more.",
  "credit.thesesEquiv_one": "≈ {label} complete thesis",
  "credit.thesesEquiv_other": "≈ {label} complete theses",
  "credit.balance": "{count} credits",
  "credit.theses": "Theses",
  "credit.orders": "Orders",
  "credit.paid": "Payment successful. Credits will land shortly.",
  "credit.loading": "Loading packs…",
  "credit.loadError": "Could not load packages.",
  "credit.payCard": "Pay by card",
  "credit.payCardBusy": "Starting…",
  "credit.paypalBusy": "Starting…",
  "credit.sepay": "Bank transfer",
  "credit.sepayBusy": "Creating…",
  "credit.save": "Save {pct}%",
  "credit.credits": "{count} credits",
  "credit.perK": "{price} / 1,000 credits",
  "credit.cheaper": "{pct}% cheaper per credit than Starter",
  "credit.featured": "Most chosen",
  "credit.bestRate": "Best rate",
  "credit.pkg.starter_package": "Starter",
  "credit.pkg.standard_package": "Standard",
  "credit.pkg.expert_package": "Expert",
  "credit.blurb.starter_package": "A single top-up when you need it.",
  "credit.blurb.standard_package": "The one most people pick.",
  "credit.blurb.expert_package": "Lowest price per credit.",
  "credit.notesTitle": "If something goes wrong",
  "credit.note.refund": "Full refund if a tool fails or a draft cannot be completed.",
  "credit.note.deduct": "Charged when a run starts. Refunded automatically on engine error.",
  "credit.note.confirm": "Credits land within 1-3 minutes after payment confirms.",
  "credit.sepay.title": "Bank transfer via SePay",
  "credit.sepay.hint": "Scan the QR or transfer with the exact content. Credits land in 1-2 minutes.",
  "credit.sepay.paid": "Payment received. Credits have been added.",
  "credit.sepay.bank": "Bank",
  "credit.sepay.account": "Account",
  "credit.sepay.amount": "Amount",
  "credit.sepay.content": "Transfer content",
  "credit.sepay.keepCode": "Keep the code {code} in the transfer content so credits are added automatically.",
  "credit.sepay.waiting": "Waiting for payment…",
  ...
  "chat.composer.usingSkill": "Using {skill}",
  ...
  "context.field.design": "Design",
  "context.field.tool": "Tool",
  "context.field.sample": "Sample",
  "context.field.sampling_strategy": "Sampling strategy",
  "context.field.target_sample": "Target sample",
  "context.field.mixed_design": "Mixed design",
  ...
  "context.empty.nothingCommitted": "Nothing committed yet.",
  "context.empty.m1NotSet": "Topic not set yet — start in M1.",
  "context.empty.m1None": "No M1 data committed yet.",
  "context.empty.m2None": "No literature yet — run M2 scout to gather sources.",
  "context.empty.m2DataNone": "No M2 data committed yet.",
  "context.empty.m5NotWritten":
    "Not written yet — M5 adds the closing chapter (conclusion). Chapters 1–4 are written by M1–M4 as you finish them, so you can export what exists at any point.",
  "context.empty.noSources": "No sources yet.",
  "context.empty.noConceptualModel": "No conceptual-model graph committed yet.",
  "context.empty.questionnaireEmpty": "Questionnaire is empty.",
  ...
  "editor.sources.title": "Sources ({count})",
  "editor.sources.empty": "No references yet.",
  "editor.sources.open": "Open the paper in a new tab",
  "editor.diff.title": "Unsaved changes",
  "editor.diff.legend": "Green is added, red is removed, grey is unchanged.",
  "editor.diff.none": "Nothing differs from the saved version.",
  "editor.diff.close": "Close",
  "editor.save.clean": "No changes yet",
  "editor.save.unsaved": "Unsaved changes",
  "editor.save.saving": "Saving…",
  "editor.save.savedAt": "Saved at {time}",
  "editor.save.action": "Save",
  "editor.save.failed": "Could not save — keep this tab open and try again.",
  "editor.backToChat": "Back to chat",
  "editor.export.download": "Download the {kind}",
  "editor.export.last": "Last export:",
  "editor.export.never": "never",
  "editor.export.justNow": "just now",
  "editor.export.minutesAgo": "{count}m ago",
  "editor.export.hoursAgo": "{count}h ago",
  "editor.export.editsSince": "{count} edits since",
  "editor.export.failed": "Export failed — {message}",
  "editor.export.exporting": "Exporting…",
  "editor.export.reExport": "Re-export",
  ...
  "context.modal.methodology": "Methodology",
  "context.modal.conceptualModel": "Conceptual model",
  "context.modal.hypotheses": "Hypotheses ({count})",
  "context.modal.questionnaire": "Questionnaire",
  "context.modal.methodologySubtitle": "Design · sampling · analysis",
  "context.modal.conceptualModelSubtitle": "Constructs and hypothesis paths",
  "context.modal.hypothesesSubtitle": "All committed hypotheses",
  ...
  "context.value.paradigm.interpretivist": "Interpretivist",
  "context.value.paradigm.constructivist": "Constructivist",
  "context.value.paradigm.pragmatist": "Pragmatist",
  "context.value.paradigm.quantitative": "Quantitative",
  "context.value.paradigm.qualitative": "Qualitative",
  "context.value.paradigm.mixed": "Mixed methods",

  "context.value.design.cross_sectional_survey": "Cross-sectional survey",
  "context.value.design.longitudinal_survey": "Longitudinal survey",
  "context.value.design.survey": "Survey",
  "context.value.design.pls_sem": "PLS-SEM",
  "context.value.design.cb_sem": "CB-SEM",
  "context.value.design.case_study": "Case study",
  "context.value.design.experiment": "Experiment",

  // --- admin list filters ---
  "admin.papers.title": "Papers",
  "admin.papers.subtitle": "Every thesis project across all users.",
  "admin.filters.topic": "Topic",
  "admin.filters.owner": "Owner",
  "admin.filters.module": "Module",
  "admin.filters.status": "Status",
  "admin.filters.searchTopic": "Search topic or field…",
  "admin.filters.searchOwner": "Filter by owner email",
  "admin.filters.allModules": "All modules",
  "admin.filters.allStatus": "All status",
  "admin.filters.allStatuses": "All statuses",
  "admin.jobs.title": "Jobs",
  "admin.orders.title": "Orders",
  "admin.blog.allLocales": "All locales",
  "admin.blog.allStatuses": "All statuses",
