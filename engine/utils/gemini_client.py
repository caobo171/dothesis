...
_FALLBACK_CHAINS = {
    "gemini-3.1-pro-preview": ["gemini-3-flash-preview", "gemini-3.5-flash-lite", "gemini-3.1-flash-lite"],
    "gemini-3-pro-preview":   ["gemini-3-flash-preview", "gemini-3.5-flash-lite", "gemini-3.1-flash-lite"],
    # gemini-3.5-flash is the default model; degrade to the Gemini 3 flash-lite
    # variants (same price tier the 2.5 flashes were) when it's overloaded, so a
    # 503 doesn't kill a turn with no downgrade path.
    "gemini-3.5-flash":       ["gemini-3-flash-preview", "gemini-3.5-flash-lite", "gemini-3.1-flash-lite"],
