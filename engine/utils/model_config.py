...
MODEL_PRICING: Dict[str, ModelPricing] = {
    # OpenAI direct (draft agents' default since 2026-09-07; GPT-6 Luna since 2026-09-23).
    ...
    # The same model through Ofox — same price as OpenAI direct (2026-09-23).
    "openai/gpt-6-luna": ModelPricing(
        input_price=0.10,
        output_price=0.50,
        name="GPT-6 Luna (Ofox)",
        display_name="GPT-6 Luna via Ofox",
        provider="ofox",
    ),
